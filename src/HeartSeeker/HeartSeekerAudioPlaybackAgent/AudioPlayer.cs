...
using HeartSeekerAudioPlaybackAgent.Services;

namespace HeartSeekerAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        {
            new AudioService().GetAudioTrack(@"sounds\Heatbeat_Speed1.wav"),
            new AudioService().GetAudioTrack(@"sounds\Heatbeat_Speed2.wav"),
            new AudioService().GetAudioTrack(@"sounds\Heatbeat_Speed3.wav"),
            new AudioService().GetAudioTrack(@"sounds\Heatbeat_Speed4.wav"),
            new AudioService().GetAudioTrack(@"sounds\Heatbeat_Speed5.wav")
        };
